...
| AXI4_STREAM_DEMO  |       Creates a data generation module AXI4_STREAM_DATA_GENERATOR and connects the module to the DMA_CONTROLLER. The AXI4_STREAM_DATA_GENERATOR module can be used to generate dummy AXI4 Stream transactions in order to benchmark the performance of the DMA_CONTROLLER.
