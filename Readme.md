...
| SPI_LOOPBACK         	| This configuration disables QSPI and enables SPI1 which is connected to MSS I/Os bank 2 and directly to the mikroBUS header. SPI0 is connected to the Raspberry Pi I/O header by default. Using this configuration SPI0 and SPI1 can be connected for loop back.  	|
...
| GENERATE_PROGRAMMING_DATA 	| Runs the full design flow after generating a design                                                                                                                                                                                                                                                                                        	|
