...
sd_create_scalar_port -sd_name ${sd_name} -port_name {FIC_3_0x4100_xxxx_0x41FF_xxxx_PREADYS1_0} -port_direction {IN}
sd_create_scalar_port -sd_name ${sd_name} -port_name {FIC_3_0x4100_xxxx_0x41FF_xxxx_PSLVERRS1_0} -port_direction {IN}
...
sd_create_scalar_port -sd_name ${sd_name} -port_name {FIC_3_0x4100_xxxx_0x41FF_xxxx_PSELS1_0} -port_direction {OUT}
...
sd_create_bus_port -sd_name ${sd_name} -port_name {FIC_3_0x4100_xxxx_0x41FF_xxxx_PRDATAS1_0} -port_direction {IN} -port_range {[31:0]}
...
sd_create_bif_port -sd_name ${sd_name} -port_name {FIC_3_0x4100_xxxx_0x41FF_xxxx} -port_bif_vlnv {AMBA:AMBA2:APB:r0p0} -port_bif_role {mirroredSlave} -port_bif_mapping {\
"PADDR:APBmslave16_PADDRS" \
"PSELx:FIC_3_0x4100_xxxx_0x41FF_xxxx_PSELS1_0" \
"PENABLE:APBmslave16_PENABLES" \
"PWRITE:APBmslave16_PWRITES" \
"PRDATA:FIC_3_0x4100_xxxx_0x41FF_xxxx_PRDATAS1_0" \
"PWDATA:APBmslave16_PWDATAS" \
"PREADY:FIC_3_0x4100_xxxx_0x41FF_xxxx_PREADYS1_0" \
"PSLVERR:FIC_3_0x4100_xxxx_0x41FF_xxxx_PSLVERRS1_0" } 
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"FIC_3_0x4100_xxxx_0x41FF_xxxx" "FIC_3_0x4xxx_xxxx_0:APBmslave1" }
