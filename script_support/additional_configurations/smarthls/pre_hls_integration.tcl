...
sd_update_instance -sd_name $sd_name -instance_name {FIC0_INITIATOR} 

source $hlsScriptDir/PCIE_INITIATOR.mod.tcl
sd_update_instance -sd_name $sd_name -instance_name {PCIE_INITIATOR} 
...
sd_instantiate_component -sd_name $sd_name -component_name {AXI2AXI} -instance_name {AXI2AXI_TO_HLS}
sd_instantiate_component -sd_name $sd_name -component_name {AXI2AXI} -instance_name {AXI2AXI_FROM_HLS}

# FIC0_INITIATOR --> AXI2AXI_TO_HLS
sd_connect_pins -sd_name $sd_name -pin_names {FIC0_INITIATOR:AXI4mslave3 AXI2AXI_TO_HLS:AXI4_SLAVE}
sd_mark_pins_unused -sd_name $sd_name -pin_names {AXI2AXI_TO_HLS:AXI4_MASTER}

# PCIE_INITIATOR <-- AXI2AXI_FROM_HLS
sd_connect_pins -sd_name $sd_name -pin_names {AXI2AXI_FROM_HLS:AXI4_MASTER PCIE_INITIATOR:AXI4mmaster1}
