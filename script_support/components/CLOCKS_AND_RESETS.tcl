...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLK_62_5MHz" "RESET_CLK_62_5MHz:CLK" "CLK_125MHz_to_CLK_62_5Mhz:CLK_OUT" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLK_125MHz" "GLITCHLESS_MUX:CLK1" "CLK_125MHz_to_CLK_62_5Mhz:CLK_IN" "RESET_CLK_125MHz:CLK" "TRANSMIT_PLL_0:CLK_125" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"RESET_CLK_125MHz:INIT_DONE" "INIT_MONITOR_0:DEVICE_INIT_DONE" "RESET_CLK_62_5MHz:INIT_DONE" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"INIT_MONITOR_0:FABRIC_POR_N" "RESET_CLK_62_5MHz:FPGA_POR_N" "RESET_CLK_125MHz:FPGA_POR_N" }
