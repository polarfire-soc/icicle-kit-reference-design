...
sd_create_scalar_port -sd_name ${sd_name} -port_name {SDIO_control} -port_direction {OUT}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"COREGPIO_C0:PCLK" "CORE_I2C_C0_0_WRAPPER_1:PCLK" "CoreUARTapb_C0_0:PCLK" "IHC_SUBSYSTEM_0:pclk" "PCLK" "PWM:PCLK" "RECONFIGURATION_INTERFACE_0:PCLK" "RPi_ID_I2C:PCLK" "sdio_register_0:pclk" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"COREGPIO_C0:PRESETN" "CORE_I2C_C0_0_WRAPPER_1:PRESETN" "CoreUARTapb_C0_0:PRESETN" "IHC_SUBSYSTEM_0:presetn" "PRESETN" "PWM:PRESETN" "RECONFIGURATION_INTERFACE_0:PRESETN" "RPi_ID_I2C:PRESETN" "sdio_register_0:presetn" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"SDIO_control" "sdio_register_0:SDIO_control" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"FIC_3_ADDRESS_GENERATION_1:FIC_3_0x4FFF_FFxx" "sdio_register_0:APBslave" }
